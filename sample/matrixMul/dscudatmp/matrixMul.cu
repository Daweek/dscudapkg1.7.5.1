static char *Ptxdata = 
    ...
    "\n"
    "	//-----------------------------------------------------------\n"
    "	// Compiling /tmp/tmpxft_00001805_00000000-9_matrixMul.cpp3.i (/tmp/ccBI#.PIrXuf)\n"
    "	//-----------------------------------------------------------\n"
    "\n"
    "	//-----------------------------------------------------------\n"
    "	// Options:\n"
    ...
    "\n"
    "	.file	1	\"<command-line>\"\n"
    "	.file	2	\"/tmp/tmpxft_00001805_00000000-8_matrixMul.cudafe2.gpu\"\n"
    ...
    "	.reg .f32 %f<100>;\n"
    "	.reg .pred %p<4>;\n"
    "	.shared .align 4 .b8 __cuda___cuda_local_var_39217_38_non_const_Bs32[4096];\n"
    "	.shared .align 4 .b8 __cuda___cuda_local_var_39216_36_non_const_As4128[4096];\n"
    "	.loc	14	89	0\n"
    ...
    "	@%p1 bra 	$Lt_0_3330;\n"
    "	mov.u64 	%rd1, __cuda___cuda_local_var_39217_38_non_const_Bs32;\n"
    "	mov.u64 	%rd2, __cuda___cuda_local_var_39216_36_non_const_As4128;\n"
    "	ld.param.s32 	%r4, [__cudaparm__Z11matrixMulDSPfS_S_ii_wA];\n"
    "	add.s32 	%r12, %r4, 31;\n"
    "	shr.s32 	%r13, %r12, 31;\n"
    "	mov.s32 	%r14, 31;\n"
